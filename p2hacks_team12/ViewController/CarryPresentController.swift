...
class CarryPresentController: UIViewController {
    ...
    var recorder:ParentAudioRecorder!
    var timer: Timer!
    var checksound:Float = 0.0 //音の大きさを格納
    var levelboader1to2:Float = 0.02 //1から2に警告が変わるライン
    var levelboader2to3:Float = 0.04 //2から3に警告が変わるライン
